...
module.exports = {
	data: new SlashCommandBuilder()
		...
		.addUserOption((option) =>
			option.setName('user').setDescription(`Who's nickname to change.`).setRequired(true)
		)
		.addStringOption((option) =>
			option
				.setName('nick')
				.setDescription('What you want to change their nickname to. (Limit 32 characters)')
				.setRequired(true)
		),
