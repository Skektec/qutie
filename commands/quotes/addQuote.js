...
module.exports = {
	data: new SlashCommandBuilder()
		...
		.addStringOption((option) =>
			option.setName('quote').setDescription('The text you want to quote.').setRequired(true)
		)
		.addUserOption((option) =>
			option.setName('user').setDescription(`The person you're quoting.`).setRequired(false)
		)
		.addStringOption((option) =>
			option
				.setName('nick')
